...
class Game {
  ...
  addFullscreenLink() {
    ...
    this.stage.hud.fullscreenLink = '全螢幕 (f)';
  }
  addMuteLink() {
  ...
  addLinkToLevelCreator() {
    ...
    this.stage.hud.levelCreatorLink = '關卡製作 (c)';
  }
  ...
  bindEvents() {
    ...
    document.addEventListener('fullscreenchange', () => {
      if (document.fullscreenElement) {
        this.stage.hud.fullscreenLink = '退出全螢幕 (f)';
      } else {
        this.stage.hud.fullscreenLink = '全螢幕 (f)';
      }
    });
  ...
  showReplay(replayText) {
    ...
    this.stage.hud.replayButton = replayText + ' 再玩一次?';
  }
