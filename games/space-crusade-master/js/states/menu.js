...
Game.States.Menu.prototype = {
	create: function () {
		...
		this.btnPlayText = this.game.add.text(this.game.width / 2, 12, '開始', { font: '20px Arial', fill: '#ffffff' });
		this.btnPlayText.anchor.setTo(0.5, 0);
		...
		this.btnMoreText = this.game.add.text(this.game.width / 2, 12, '更多遊戲', { font: '20px Arial', fill: '#ffffff' });
		this.btnMoreText.anchor.setTo(0.5, 0);
