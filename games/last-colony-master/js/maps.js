var maps = {
	"singleplayer": [
		{
			"name": "救援行動",
			"briefing": "自從大戰以來，人類陷入了混亂。數十億人死亡，城市成為廢墟。\n倖存者組成小團體，盡力生存下去。\n我們正試圖聯繫該區域的所有倖存者，然後與主殖民地會合。",
			...
			"triggers": [
				{
					...
					"action": function () {
						game.showMessage("op", "指揮官！！我們已經超過兩個小時沒有收到上一支車隊的消息了。他們現在應該已經到了。");
					}
				},
				{
					"type": "timed", "time": 10000,
					"action": function () {
						game.showMessage("op", "他們最後一次出現是在西北扇區。你能去調查一下嗎？");
					}
				},
				{
					"type": "conditional",
				...
				},
				{
					...
					"action": function () {
						game.showMessage("op", "叛軍最近變得非常具有侵略性。希望車隊安全。找到他們並將他們護送回基地。");
					}
				},
				{
					"type": "conditional",
				...
				},
				{
					...
					"action": function () {
						game.showMessage("driver", "有人聽到嗎？我們的車隊被叛軍坦克壓制住了。我們需要支援。");
					}
				},
				{
					"type": "conditional",
					...
					"action": function () {
						var hero = game.getItemByUid(-1);
						game.showMessage("driver", "謝謝。我們以為這次死定了。");
		...
		{
			"name": "突襲",
			"briefing": "多虧了車隊的補給，我們現在基地已經運作起來了。\n 附近的叛軍是個問題。我們需要消滅他們。\n 首先建立基地防禦。然後找到並消滅該區域的所有叛軍。\n 殖民地將派遣增援部隊來協助我們。",
			...
			"triggers": [
				{
					...
					"action": function () {
						...
						game.showMessage("op", "指揮官！！增援部隊已從殖民地抵達。");
				...
				},
				{
					...
					"action": function () {
						// Supply extra cash
						game.cash["blue"] = 1500;
						game.showMessage("op", "指揮官！！我們有足夠的資源再建造一個地面砲塔。建立砲塔以保護基地免受更多攻擊。");
					}
				},
				...
				// Send in some reinforcements every three minutes
				{
					...
					"action": function () {
						game.showMessage("op", "指揮官！！更多增援部隊抵達了。");
				...
				// Send in air support after 10 minutes
				{
					...
					"action": function () {
						game.showMessage("pilot", "近距離空中支援在途中。我會盡力而為。");
		...
		},
		{
			...
			"triggers": [
				...
				},
				{
					...
					"action": function () {
						game.showMessage("op", "指揮官！！叛軍開始攻擊了。我們需要不惜一切代價保護基地。");
					}
				},
				{
					...
					"action": function () {
						...
						game.showMessage("driver", "指揮官！！殖民地送來了一些額外的補給。我們正從東北扇區穿過叛軍領地。我們需要一點保護。");
					}
				},
				...
				// Start moving the transport,
				{
					...
					"action": function () {
						game.showMessage("driver", "謝了！感激支援。好，我們出發。");
				...
				// Pilot asks for help when attacked
				{
					...
					"action": function () {
						game.showMessage("pilot", "我們遭到攻擊！請求支援。情況不妙。");
					}
				},
				// Extra supplies from new transport
				{
					...
					"action": function () {
						game.showMessage("driver", "叛軍突然出現。我們無能為力。她救了我們的命。希望這些補給值得。");
						game.cash["blue"] += 1200;
					}
				},
				...
				//After 8 minutes, start waiting for the end
				{
					...
					"action": function () {
						game.showMessage("op", "指揮官！殖民地空軍艦隊還有幾分鐘就到了。");
					}
				},
				//After 10 minutes send in reinforcements
				{
					"type": "timed", "time": 600000,
					"action": function () {
						game.showMessage("op", "指揮官！殖民地空軍艦隊正在接近。");
