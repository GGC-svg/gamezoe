    ...
    Alert: [function (t, e, n) {
        ...
        cc._RF.push(e, "9c4a1C5sMpHGLYuQhmEcp3v", "Cannon"), cc.Class({
            ...
            setSceneMulti: function () {
                var bulletMulti = cc.yqs.bulletMgr.getBulletMulti(this.CannonKind);
                var sceneMulti = cc.yqs.gameMgr.sceneMulti;
                console.log("[SetSceneMulti] CannonKind:", this.CannonKind, "BulletMulti:", bulletMulti, "SceneMulti:", sceneMulti);
                var t = parseFloat(bulletMulti * sceneMulti).toFixed(3);
                console.log("[SetSceneMulti] Final cost:", t);
        ...
        cc._RF.push(e, "a293578d6FJgonO364JAa+U", "GameNetMgr"), cc.Class({
            ...
            initHandlers: function () {
                ...
                cc.yqs.net.addHandler("login_result", function (e) {
                    ...
                    console.log("[RoomBaseScore_CHECK1] e.data exists?", !!e.data);
                    console.log("[RoomBaseScore_CHECK2] e.data.roomBaseScore:", e.data ? e.data.roomBaseScore : "NO DATA");
                    if (cc.log("login_result: " + e), 0 === e.errcode) {
                        ...
                        // [FIX] Set chairId immediately (from OLD FILE working version)
                        // [CRITICAL] Force String comparison to avoid BigInt precision issues
                        var myUserIdStr = String(cc.yqs.userMgr.userId);
                        console.log("[ChairIdFix] My UserId (String):", myUserIdStr);

                        for (var n = 0; n < e.seats.length; ++n) {
                            if (String(e.seats[n].userId) === myUserIdStr) {
                                cc.yqs.userMgr.chairId = e.seats[n].seatIndex + 1;
                                console.log("[ChairIdFix] Set chairId to:", cc.yqs.userMgr.chairId);
                                break;
                            }
                        }
        ...
        cc._RF.push(e, "88495SoqZJKX6a5qY/jeUBv", "RoomMgr"), cc.Class({
            ...
            game_sync: function (t) {
                ...
                console.log("[SceneMulti] roomBaseScore:", t.detail.roomBaseScore, "Type:", typeof t.detail.roomBaseScore);
                cc.yqs.gameMgr.sceneMulti = Math.floor(t.detail.roomBaseScore) / 1e3;
                console.log("[SceneMulti] Calculated sceneMulti:", cc.yqs.gameMgr.sceneMulti);
                this.initView(t.detail.seats), this.initSeats(t.detail.seats)
            },
            new_user: function (t) {
        ...
        cc._RF.push(e, "77784LRrLtNUZqXof19dK1m", "zh"), window.i18n || (window.i18n = {}), window.i18n.languages || (window.i18n.languages = {}), window.i18n.languages.zh = {
            ...
            key187: "请输入充值金额",
            key188: "更换头像",
            key189: "本次更改免费，确定更换头像？",
            key190: "本次更改需要花费1元，确定更换头像？",
            key191: "您已达最高级！",
            key192: "更换失败，金币不足",
            key193: "渔场ID: ",
            key194: "正在同步鱼群",
            ...
            key113: "深海寶藏",
            key114: "打魚可以累積激光能量（不同場次的能量不通用）",
            key115: "對著一群魚來一發，抓準時機猛賺一筆",
            key116: "滿能量狀態時，點擊砲台，可以切換激光砲",
            key117: "激光砲對炸彈類魚和聚寶盆無效，激光砲被激活後需要在30秒內發射",
            key118: "奪寶流程",
            key119: "打鉆石魚",
            key120: "集鉆石",
            key121: "開寶箱",
